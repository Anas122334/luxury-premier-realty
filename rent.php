<?php
$title = "Luxury Premier Realty-Rental Page for property";
$description = "Luxury Premier Realty has made searching for rental properties, scheduling viewings, making offers, counteroffers, and closing successfully simpler.";
    ...
    <div class="container mt-5 pb-5">
        <div class="row g-5">
            <div class="col-12 col-md-4 col-sm-12">
                <a href="property-page.php" class="text-decoration-none text-dark">
                        ...
                        <div class="swiper mySwiper2">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    ...
                                    <div class="tag humnst">FOR RENT</div>
                                </div>
                                <div class="swiper-slide">
                                    <img src="assests/images/buy-card-img1.webp" class="img-fluid w-100" alt="">
                                    <div class="tag humnst">FOR RENT</div>
